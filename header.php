...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- SidebarSearch Form -->
      <div class="info">
          <a href="#" class="d-block">Valor del dolar</a>
        </div>
      ...
      <div class="form-inline">
        ...
        <button type="submit" class="btn btn-sidebar" style="width:50%">
                Guardar
        </button>
        <button id="actualizarDolarBtn" type="button" class="btn btn-sidebar" style="width:50%">
                Actualizar
        </button>
      </div>
      </form>
